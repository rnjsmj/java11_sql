...
alter table book2 add constraint book2_fk foreign key (bookkind) 
...
create or replace view book_view as select bookkind, booktitle, 
bookprice * 1.1 as bookprice, pubcom 
from book where bookkind in ('IT', 'TC', 'HC');
