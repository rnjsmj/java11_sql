...
-- 저자(author), 수량(bookcount)를 조회하시오.									
...
-- 60) 외부조인을 활용하여 판매되지 않은 도서의 도서명(booktitle), 도서가격(bookprice), 저자(author)를 조회하시오.									
